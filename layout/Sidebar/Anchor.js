...
const Anchor = ({
  ...
  const content = (
    <a
      className={`flex items-center px-3 py-px h-10 text-gray-100 cursor-pointer hover:text-white focus:text-opacity-100 outline-none ease-in-out transition-all duration-150 ease-in-out truncate ${
